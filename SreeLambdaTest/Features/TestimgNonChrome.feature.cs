...
namespace SreeLambdaTest.Features
{
...
#line 1 "TestimgNonChrome.feature"
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Chrome", "LambdaTest Sample App", "N Item", null)]
        public virtual void AddItemsToTheToDoApp(string browser, string title, string newItem, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("NewItem", newItem);
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 6
 testRunner.Given(string.Format("I navigate to LamdaTest App on following {0} with {1}", browser, title), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 7
...
#line hidden
#line 9
 testRunner.And(string.Format("I enter the {0} in textbox", newItem), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 10
 testRunner.When("I click the Add button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 11
 testRunner.Then(string.Format("I verify whether {0} is added to the list", newItem), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
